...
class ProductStoreValid extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'image'               => 'required|mimes:jpeg,png,jpg|image|max:10240',
            'images.*'            =>'required|mimes:jpeg,png,jpg|image|max:10240',
            ...
            'additional_data.delivery_days'       => 'required|string|max:100',
            'additional_data.delivery_price'       => 'required|string|max:100',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'additional_data.delivery_days.required'  => 'من فضلك مطلوب أيام التوصيل  ',
            'additional_data.delivery_price.required'  => 'من فضلك مطلوب سعر التوصيل  ',
    ...
    public function validated()
    {
        ...
        return collect($data)->except(['image','images','frame_color_id','lens_color_id'])->toArray();
    }
}
