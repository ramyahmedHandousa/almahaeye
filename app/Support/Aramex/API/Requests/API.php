...
namespace App\Support\Aramex\API\Requests;

use App\Support\Aramex\API\Classes\ClientInfo;
use App\Support\Aramex\API\Classes\Transaction;
...
abstract class API implements Normalize
{
    ...
    {
        if ($this->isLive()) {
            return dirname(__FILE__) . $this->live_wsdl;
        } else {
            return dirname(__FILE__) . $this->test_wsdl;
        }
    }
