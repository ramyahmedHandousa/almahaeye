...
namespace App\Support\Aramex\API\Requests\Rate;
...
use App\Support\Aramex\API\Response\Rate\RateCalculatorResponse;
...
class CalculateRate extends API implements Normalize
{
    ...
    protected $live_wsdl = '/../WSDLs/live/rate.xml';
    protected $test_wsdl = '/../WSDLs/test/rate.xml';
