        ...
        <form class="row validation-code" action="{{route('auth-send-forget-password')}}" method="POST">
            {{csrf_field()}}
                ...
                <div class="col-lg-6 form-group " style="margin-bottom: 50px;margin-top: 20px">
                    <span class="label label-info">الهاتف:</span>
                    <input type="text" name="phone" placeholder="برجاء إدخل الهاتف من فضلك "  maxlength="20" class="form-control inputCode" required>
