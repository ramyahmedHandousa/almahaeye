...
@endsection
@section('content')
    <form id="myForm" method="POST" action="{{ route('shipping.store') }}" enctype="multipart/form-data" data-parsley-validate
          novalidate>
    {{ csrf_field() }}
                ...
                <div class="card-box">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="price"  min=0 oninput="validity.valid||(value='');" class="form-control requiredFieldWithMaxLenght" required>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="time_delivery" value="{{ old('time_delivery')}}"
                                   class="form-control requiredFieldWithMaxLenght"
                                   required placeholder="الوقت المتوقع للتوصيل"
                                   min="1"/>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group" style="margin-top: 20px">
                            ...
                            <input type="checkbox" name="pay" value="1" id="pay"
                                   class=""  placeholder="الدفع عند الاستلام" checked />
