...
@section('content')
    ...
    <form   method="POST" action="{{ route('promo_codes.update', $promoCode->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="code" min=1 maxlength="10" oninput="validity.valid||(value='');"
                                       class="form-control number " value="{{$promoCode->code}}" required />
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="time_used" value="{{$promoCode->time_used}}" min=1 maxlength="6" oninput="validity.valid||(value='');"
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group bootstrap-touchspin">
                                        <input class="form-control  " min="1" value="{{$promoCode->percentage}}" type="text" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="start_at"  class="form-control  datepicker  "
                                           value="{{$promoCode->start_at->format("Y-m-d")}}" required />
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="end_at"  value="{{$promoCode->end_at->format("Y-m-d")}}"   class="form-control  datepicker  " required />
                                    <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
