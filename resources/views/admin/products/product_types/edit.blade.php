...
@section('content')
    ...
    <form method="POST" action="{{ route('product_types.update', $productType->id) }}"
        ...
        <div class="row">
            ...
            <div class="col-sm-12 " >
                <div class="card-box">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">تعديل بيانات  نوع النظارة</h4>


                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                            <label for="name_ar">إسم بالعربي*</label>
                            <input type="text" name="name_ar" value="{{ $productType->name }}"
                                   class="form-control"
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="name_en" value="{{ $productType?->translate('en')?->name }}"
                                   class="form-control"
