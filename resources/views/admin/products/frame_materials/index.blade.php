    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('frame_materials.create') }}"
        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <table id="datatable-fixed-header" class="table table-striped table-bordered dt-responsive nowrap">
                    ...
                    @foreach($frame_materials as $row)
                        <tr>
                            <td>{{ $row->name }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('frame_materials.edit', $row->id) }}"
                                   data-toggle="tooltip" data-placement="top"
                                   data-original-title="تعديل"
                                   class="btn btn-icon btn-xs waves-effect  btn-info">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="javascript:;" data-url="{{ route('frame_materials.delete') }}"
