...
@section('content')
    ...
    <form method="POST" action="{{ route('frame_materials.update', $frameMaterial->id) }}"
                ...
                <div class="card-box">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="name_ar" value="{{ $frameMaterial->name }}"
                                   class="form-control"
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="name_en" value="{{ $frameMaterial?->translate('en')?->name }}"
                                   class="form-control"
