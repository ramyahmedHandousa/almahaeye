...
@endsection
@section('content')
    <form id="myForm" method="POST" action="{{ route('brands.store') }}" enctype="multipart/form-data" data-parsley-validate
          novalidate>
    {{ csrf_field() }}
    ...
    <!-- Page-Title -->
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">إدارة الماركات</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card-box">
                    <h4 class="header-title m-t-0 m-b-30">إضافة ماركة</h4>
