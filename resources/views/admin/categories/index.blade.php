    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('categories.create') }}@if(request('type') == 'sub')?type=sub @endif"
                    ...
                    @foreach($categories as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('categories.edit', $row->id) }}@if(request('type') == 'sub')?type=sub @endif"
                                   data-toggle="tooltip" data-placement="top"
                                   data-original-title="تعديل"
                                   class="btn btn-icon btn-xs waves-effect  btn-info">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="javascript:;" data-url="{{ route('categories.delete') }}"
