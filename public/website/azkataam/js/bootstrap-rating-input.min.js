! function(a) {
    ...
    function b(a) { return "[data-value" + (a ? "=" + a : "") + "]" }
    ...
    var f = "rating-clear",
        g = "." + f,
        h = "hidden",
        i = { min: 1, max: 5, "empty-value": 0, iconLib: "glyphicon", activeIcon: "glyphicon-star active", inactiveIcon: "glyphicon-star", clearable: !1, clearableIcon: "glyphicon-remove", clearableRemain: !1, inline: !1, readonly: !1, copyClasses: !0 },
        j = function(a, b) {
            var c = this.$input = a;
            this.options = d(c, b);
    ...
    j.VERSION = "0.4.0", j.DEFAULTS = i, j.prototype = {
        clear: function() { this.setValue(this.options["empty-value"]) },
        setValue: function(a) { this.highlight(a), this.updateInput(a) },
    ...
    var k = a.fn.rating = function(c) {
        return this.filter("input[type=number]").each(function() {
            var d = a(this),
                e = "object" == typeof c && c || {},
                f = new j(d, e);
            f.options.readonly || f.$el.on("mouseenter", b(), function() { f.highlight(a(this).data("value"), !0) }).on("mouseleave", b(), function() { f.highlight(d.val(), !0) }).on("click", b(), function() { f.setValue(a(this).data("value")) }).on("click", g, function() { f.clear() })
        })
    };
    k.Constructor = j, a(function() { a("input.rating[type=number]").each(function() { a(this).rating() }) })
}(jQuery);